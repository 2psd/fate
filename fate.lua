...
if not isfolder("fate/configs/lol") then
    makefolder("fate/configs/lol")
end
...
local nigga = (function() -- src/Lua/loader.lua
    ...
    function loaderOptions:new()
        ...
        Information.Text = "Version Loaded : lol"
    ...
    local function my_script()
        ...
        if chosen_game == "lol" then
            (function() -- src/Lua/Scripts/lol/lol.lua
                ...
                if please_load then
                    do
                        (function() -- src/Lua/Scripts/lol/things.lua
                            function lol.functions:is_alive(player)
                            	return player
                            ...
                            function lol.functions:is_localplayer_alive()
                            	return self:is_alive(LocalPlayer)
                            end
                            
                            function lol.functions:is_moving(player)
                            	if player then
                            ...
                            function lol.functions:is_localplayer_moving()
                            	return self:is_moving(LocalPlayer)
                            end
                            
                            function lol.functions:wall_check(Character)
                            ...
                            function lol.functions:getentities()
                            	local entities = {}
                            	for _, player in ipairs(playerService:GetPlayers()) do
                            		...
                            		if not lol.functions:is_alive(player) then
                            			continue
                            		end
                            ...
                            function lol.functions:getnearestplayertomouse(distance, settings)
                            	local entity = nil
                            ...
                            function lol.functions:custom_getnearestplayertomouse(distance, settings)
                            	local entity = nil
                            	local distance = distance
                            	for i, v in next, self:getentities() do
                                    if settings.friends and playerService[v.Name]:IsFriendsWith(LocalPlayer.UserId) then
                            ...
                            function lol.functions:getclosestpart(character, config)
                            ...
                            function lol.functions:closestpoint(part)
                            ...
                            function lol.functions:mouse_aim(arguments)
                            ...
                            -- lol custom prediction
                            -- taken from fatality.
                            function lol.functions:custom_prediction(HitPosition, Vel, BulletTravel, Configuration)
                            ...
                            function lol.functions:camera_aim(arguments)
                            ...
                            function lol.functions:get_main_event()
                            ...
                            function lol.functions:get_gun()
                            	local gun
                            ...
                            function lol.functions:get_gun_2(player)
                            	local info = {
                            		isgunequipped = false,
                            		ammo = nil,
                            		tool = nil
                            ...
                            function lol.functions:get_gun_from_character(character)
                            	local gun
                            ...
                            function lol.functions:get_aim_arg() -- shitty
                            	return mouse_arg:Get()
                            end
                        end)()
                    end
                    
                    local Interface = UserInterface:Create{title = 'fate<font color="rgb(168, 157, 159)">.lol</font>',}
                    
                    do -- src/Lua/Scripts/lol/components/
                        do -- src/Lua/Scripts/lol/components/a_aimassist.lua
                                ...
                                if type(bone) == "table" and #bone > 0 then
                                    if closest_mode ~= "none" then
                                        if closest_mode == "closest part" then
                                            local newBone = tostring(lol.functions:getclosestpart(character, bone))
                                        ...
                                        elseif closest_mode == "closest point" then
                                            ...
                                            if type(newBone) == "string" and newBone ~= "" and character:FindFirstChild(newBone) then
                                                position = lol.functions:closestpoint(character[newBone])
                                            end
                                        end
                                    end
                                end
                            ...
                            function aimassist:enable()
                                if ((tick() - old_frame) >= (1/update_time)) then
                                    ...
                                    if aimassist.enable_on_move then
                                        if not lol.functions:is_localplayer_moving() then return end
                                        aimassist:aim()
                                    else
                                        aimassist:aim()
                                    end
                            ...
                            local function get_aim_assist_character()
                                if aimassist.lock_target then
                                    local char = lol.functions:getnearestplayertomouse(aimassist.fieldofview, aimassist.configuration)
                                    if char ~= nil and aimassist.lock_target_state == false then
                                        aimassist.lock_target_state = true
                                        aimassist.character = char
                                    end
                                else
                                    aimassist.character = lol.functions:getnearestplayertomouse(aimassist.fieldofview, aimassist.configuration)
                                end
                            end
                        ...
                        do -- src/Lua/Scripts/lol/components/b_silentaim.lua
                            ...
                            function silentaim:get_position()
                                ...
                                if type(bone) == "table" and #bone > 0 then
                                    if closest_mode ~= "none" then
                                        if closest_mode == "closest part" then
                                            local newBone = tostring(lol.functions:getclosestpart(silentaim.character, bone))
                                        ...
                                        elseif closest_mode == "closest point" then
                                            ...
                                            if type(newBone) == "string" and newBone ~= "" and silentaim.character:FindFirstChild(newBone) then
                                                position = lol.functions:closestpoint(silentaim.character[newBone])
                                            end
                                        end
                                    end
                                end
                            	...
                            	if silentaim.custom_calculation then
                            		...
                            		position = lol.functions:custom_prediction(position, player_velocity, ping, {
                            ...
                            function silentaim:enable()
                                ...
                                if not lol.functions:is_localplayer_alive() then
                            ...
                            local function aim()
                                ...
                                local main_event = lol.functions:get_main_event()
                                local aim_Arg = lol.functions:get_aim_arg()
                            ...
                            function silentaim:init()
                                LocalPlayer.Character.ChildAdded:Connect(function (Child)
                                    local gun = lol.functions:get_gun_2(LocalPlayer)
                            ...
                            local function normal()
                                if silentaim.lock_target then
                                    local char = lol.functions:custom_getnearestplayertomouse(silentaim.fieldofview, silentaim.configuration)
                                    if char ~= nil and silentaim.lock_target_state == false then
                                        silentaim.lock_target_state = true
                                        silentaim.character = char
                                    end
                                else
                                    silentaim.character = lol.functions:custom_getnearestplayertomouse(silentaim.fieldofview, silentaim.configuration)
                                end
                            end
                        ...
                        do -- src/Lua/Scripts/lol/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("fate.universal")
                                ...
                                local function updateHealthCache ()
                                    if skeleton_hit or hit_options.enabled then
                                        for _, player in pairs(playerService:GetPlayers()) do
                                            if not lol.functions:is_alive(player) then continue end
                            ...
                            do -- visualizer
                                ...
                                local function aimposF()
                                    ...
                                    if not lol.functions:get_gun() then
                                        aimposVisualizer.Visible = false
                                        return
                                    end
                        ...
                        do -- src/Lua/Scripts/lol/components/d_misc.lua
                            ...
                            if game.PlaceId ~= 9825515356 then
                                do
                                    ...
                                    function auto_buy:start()
                                        if not lol.functions:is_localplayer_alive() then return end
                            ...
                            do -- animation
                                ...
                                function animation_options:play(animation)
                                    ...
                                    pcall(function ()
                                        ...
                                        lol.functions:get_main_event():FireServer(table.unpack(args))
                                    end)
                                end
                                ...
                                if game.PlaceId ~= 9825515356 then
                                    do
                                        ...
                                        local NoSitFunctions = {
                                            NoSit = function ()
                                                if lol.functions:is_localplayer_alive() then
                            ...
                            do
                                ...
                                function aimviewer:enable()
                                    if not lol.functions:is_localplayer_alive() then disable() return end
                                    ...
                                    local gun = lol.functions:get_gun_from_character(character)
                                ...
                                AVtoggle:Keybind({ title = "keybind", keybindlist = true, keybindname = "aim viewer", mode = "Toggle", callback = function (key)
                                    ...
                                    if key and aimviewer.enabled and aimviewer.keybind_enabled then
                                        aimviewer.target = lol.functions:getnearestplayertomouse(100, {  
                                            visibility = true,
                                            wallcheck = false,
                                            team = false,
                                            friends = false,
                        ...
                        do -- src/Lua/Scripts/lol/components/e_playerlist.lua
                                ...
                                if bool then
                                    Loops:AddToRenderStepped("RenderMarkPLayer", function ()
                                        ...
                                        if current_player then
                                            ...
                                            if lol.functions:is_alive(player) then
                                                local character = player.Character
                        ...
                        do -- src/Lua/Scripts/lol/components/f_settings.lua
                            local config = {
                                path = "fate/configs/lol/",
                                file = "",
                                config_name = ""
                            }
                            function config:get_list()
                                ...
                                if #listfiles("fate/configs/lol") > 0 then
                                    for i, v in next, listfiles("fate/configs/lol") do
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'fate<font color="rgb(168, 157, 159)">.universal</font>',}
