-- starting to work on this again. What is Fate? Fate is a Drax Remake Although it got leaked i made it this far so might aswell finish.

-- Things to Finish. Fully Finish Ui, Fully Finish Slient Aim, Fully Finish Visuals. And Add Aim Assist
...
-- I'm Gonna Start Adding Notes Cus Yes.
...
local UserInterface = (function() 
    ...
    function UserInterface:Create(OptionsLaughtOutLouds)
        ...
        UI["a"]["Text"] = [[fully remade by @2psd]]
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                local current_mouse_arg = "UpdateMousePos"
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'fate<font color="rgb(168, 157, 159)">.dahood</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("fate/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("fate/configs/da_hood") do
